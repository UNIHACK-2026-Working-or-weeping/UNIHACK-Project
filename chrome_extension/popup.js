document.addEventListener("DOMContentLoaded", function () {
  ...
  function parseIcs(icsData) {
    ...
    console.log("[Calendar][Chrome] Parsed ICS", {
    ...
    chrome.storage.local.set(
      ...
      () => {
        if (chrome.runtime.lastError) {
          console.error(
            "[Calendar][Chrome] Failed to store nearestEvent",
            chrome.runtime.lastError.message,
          );
        } else {
          console.log("[Calendar][Chrome] Stored nearestEvent", nearestEvent);
        }
      },
    );
  }
  ...
  icsFileInput.addEventListener("change", function (e) {
    ...
    reader.onload = function (e) {
      try {
        ...
        console.error("[Calendar][Chrome] Failed to parse ICS", error);
      }
    };
    reader.onerror = function () {
      console.error("[Calendar][Chrome] Failed to read file");
    };
